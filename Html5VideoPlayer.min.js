...
Html5VideoPlayer.prototype.control=function(a,b){var c=document.createElement("div");c.id="video_control_"+(new Date).getTime();c.style.position="absolute";c.style["z-index"]=this.vZIndex+3;c.style.width=this.vWidth;c.style.height=40;a.appendChild(c);c.style["background-color"]="#dadada";c.style["margin-top"]=this.vHeight-40;var d=document.createElement("li");d.style.width=40;d.style.height=40;d.style["list-style-type"]="none";d.style["background-image"]='url("./css/timg.jpg")';d.style["background-position"]=
"-20 -20";c.appendChild(d);d.addEventListener("click",function(){b.paused?b.play():b.pause()});a.addEventListener("mouseover",function(){c.style.display="block"});a.addEventListener("mouseout",function(){setTimeout(function(){c.style.display="none"},3E3)})};
